...
@UIApplicationMain
public class AppUnderControlDelegate: UIResponder, UIApplicationDelegate {
    
    public var window: UIWindow?
    
    public func appUnderControlGetTokenSeed() -> String {
        return "0fe95477-d64c-4e0d-a60d-956333d549e"
    }
    
    public func appUnderControl(app: AppUnderControlDelegate, didReceiveValidToken: String) {
        
    }
    
    // "#callbackScheme://#token"
    public func application(application: UIApplication, openURL url: NSURL, sourceApplication: String?, annotation: AnyObject) -> Bool {
        TokenVerification.verfifyOpenUrl(self, openURL: url)
